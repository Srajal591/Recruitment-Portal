...
export const candidateService = {
  ...
  async savePersonalDetails(id, data) {
    const response = await apiClient.put(`/candidate/applications/${id}/personal-details`, data)
    return unwrapData(response)
  },
  async saveEducation(id, data) {
    const response = await apiClient.put(`/candidate/applications/${id}/education`, data)
    return unwrapData(response)
  },
  async saveAdditionalInfo(id, data) {
    const response = await apiClient.put(`/candidate/applications/${id}/additional-info`, data)
    return unwrapData(response)
  },
  async saveAddress(id, data) {
    const response = await apiClient.put(`/candidate/applications/${id}/address`, data)
    return unwrapData(response)
  },
  ...
  async savePostSelection(id, data) {
    const response = await apiClient.put(`/candidate/applications/${id}/post-selection`, data)
    return unwrapData(response)
  },
